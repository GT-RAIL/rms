 ...
 *
 * The main study admin panel allows read/write access to study SQL tables via a GUI.
 *
...
if($session_user['type'] !== 'admin') {
  write_to_log('WARNING: '.$session_user['username'].' attempted to access the study panel.');
        ...
        <div class="admin-tabs-container">
          <div id="admin-tabs">
            <ul>
              ...
              <li><a href="#experiments-tab">Manage Experiments</a>
              </li>
              ...
              <div id="studies">
                ...
                <table class="tablesorter">
                  ...
                  for ($i = 0; $i < $num_studies; $i++) {
                    ...
                    <tr class="<?php echo $class?>">
                      <td class="delete-cell">
                        <button class="delete" name="studies"
                  ...
                  <tr>
                    <td colspan="6"></td>
                    <td class="add-cell">
                      <button class="create-new" id="add-studies"
                        name="studies">Add Study</button>
                    </td>
                  </tr>
                </table>
              </div>
              <div id="conditions">
                ...
                <table class="tablesorter">
                  ...
                  for ($i = 0; $i < $num_conditions; $i++) {
                    ...
                    <tr class="<?php echo $class?>">
                      <td class="delete-cell">
                        <button class="delete" name="conditions"
                          id="conditions-<?php echo $cur['condid']?>">Delete</button>
                      </td>
                      <td class="edit-cell">
                        <button class="edit" name="conditions"
                          id="conditions-<?php echo $cur['condid']?>">Edit</button>
                      </td>
                      <td class="content-cell"><?php echo $cur['condid']?>
                      </td>
                      <td class="content-cell"><?php echo $cur['studyid'].': '.$study['name']?>
                      </td>
                      <td class="content-cell"><?php echo $cur['name']?>
                      </td>
                      <td class="content-cell"><?php echo $cur['intid'].': '.$interface['name']?>
                      </td>
                    </tr>
                    <?php
                  }?>
            ...
            <div id="experiments-tab">
              ...
              <table class="tablesorter">
                ...
                $num_experiments = count($experiments);
                for ($i = 0; $i < $num_experiments; $i++) {
                  ...
                  <tr class="<?php echo $class?>">
                    <td class="delete-cell">
                      <button class="delete" name="experiments"
                        id="experiments-<?php echo $cur['expid']?>">Delete</button>
                    </td>
                    <td class="edit-cell">
                      <button class="edit" name="experiments"
                        id="experiments-<?php echo $cur['expid']?>">Edit</button>
                    </td>
                    <td class="content-cell"><?php echo $cur['expid']?>
                    </td>
                    <td class="content-cell"><?php echo $cur['userid'].': '.$user['firstname'].' '.$user['lastname'].' ('.$user['username'].')'?>
                    </td>
                    <td class="content-cell"><?php echo $cur['condid'].': '.$condition['name'].' ('.$study['name'].')'?>
                    </td>
                ...
                <tr>
                  <td colspan="7"></td>
                  <td class="add-cell">
                    <button class="create-new" id="add-experiments"
                      name="experiments">Add Experiment</button>
                  </td>
                </tr>
              </table>
            </div>
