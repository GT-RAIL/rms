      ...
      <div class="center">
        <form action="javascript:submit();" method="POST"
          ...
          <fieldset>
            ...
            <ol>
              ...
              <li><label for="dbuser">Database Username</label> <input
                type="text" name="dbuser" id="dbuser"
                placeholder="username" required />
              </li>
              <li><label for="dbpass">Database Password</label> <input
                type="password" name="dbpass" id="dbpass"
          ...
          <fieldset>
            ...
            <ol>
              ...
              <li><label for="google">Google Analytics Tracking ID
                  (optional)</label> <input type="text" name="google"
                id="google" placeholder="(optional)" />
              </li>
          ...
          <fieldset>
            ...
            <ol>
              <li><label for="sqlfile">SQL Backup File (optional)</label>
